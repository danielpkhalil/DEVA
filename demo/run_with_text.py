...
def run_demo(chunk_size, img_path, amp, temporal_setting, size, output, prompt, DINO_THRESHOLD):
    ...
    cfg = {
        ...
        'model': './Tracking_Anything_with_DEVA/saves/DEVA-propagation.pth',
        'save_all': False,
        'key_dim': 64,
        'value_dim': 512,
        'pix_feat_dim': 512,
        ...
        'top_k': 30,
        'mem_every': 5,
        'GROUNDING_DINO_CONFIG_PATH': './Tracking_Anything_with_DEVA/saves/GroundingDINO_SwinT_OGC.py',
        'GROUNDING_DINO_CHECKPOINT_PATH': './Tracking_Anything_with_DEVA/saves/groundingdino_swint_ogc.pth',
        'DINO_THRESHOLD': DINO_THRESHOLD,
        'DINO_NMS_THRESHOLD': 0.8,
        'SAM_ENCODER_VERSION': 'vit_h',
        'SAM_CHECKPOINT_PATH': './Tracking_Anything_with_DEVA/saves/sam_vit_h_4b8939.pth',
